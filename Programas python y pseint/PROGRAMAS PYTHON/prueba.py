...
def forma_polar_fraccion(num_complejo):
    ...
    # Convertir radianes a fracción con π
...
# Etiqueta para mostrar el resultado en forma polar decimal
...
# Etiqueta para mostrar el resultado en forma polar fraccionaria
...
# Etiqueta para mostrar el resultado en radianes con pi
