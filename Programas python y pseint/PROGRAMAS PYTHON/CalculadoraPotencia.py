...
titulo_label = ttk.Label(mainframe, text="Calculadora de Potencias de i", font=("Times New Roman", 16, "bold"), foreground="blue")
titulo_label.grid(row=0, column=0, columnspan=2, pady=10)

label_exponente = ttk.Label(mainframe, text="Exponente:", font=("Times New Roman", 16, "bold"), foreground="brown")
...
boton_calcular = tk.Button(mainframe, text="Calcular", command=boton_calcular_potencia, font=("Times new Roman", 12, "bold"), foreground="brown", background="yellow")
